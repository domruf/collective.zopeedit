...
p.depends="bash, psmisc, python, python-tk, update-mime-database"
p.license="gpl"
p.section="utils"
p.arch="all"
...
p["/usr/lib/python2.6/dist-packages/collective.zopeedit/collective/zopeedit/Plugins"]=[i+'|'+i[28:] \
            for i in glob("collective/zopeedit/Plugins/*.py")]

p["/usr/lib/python2.6/dist-packages/collective.zopeedit/collective/zopeedit/docs"]=[i+'|'+i[5:] \
            for i in glob("docs/*.txt")]
